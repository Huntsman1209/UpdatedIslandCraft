...
import common.core.DefaultIslandCraft;
import common.core.ICLogger;
import common.core.IslandDatabase;
...
public class IslandCraftPlugin extends JavaPlugin {
	...
	public void onEnable() {
		...
		NmsWrapper nms = null;
		try {
			nms = NmsWrapper.getInstance(getServer());
		...
		IslandDatabase database = new EbeanServerIslandDatabase(ebeanServer);
